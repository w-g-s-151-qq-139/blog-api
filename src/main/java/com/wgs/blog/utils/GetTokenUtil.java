...
public class GetTokenUtil {
    ...
    //定义横向参数
    private static Long crossingAmount = 3L;
    //定义纵向参数
    ...
    public static Long confusionOperationId(Long newId){
        //公式：aX+2ab-b = y
        return newId* crossingAmount +2*portraitAmount* crossingAmount -portraitAmount;
    }

    //id还原计算
    public static Long reductionOperationId(Long confusionId){
        //公式：(y+b-2ab)/a = x
        return (confusionId+portraitAmount-2*portraitAmount* crossingAmount)/ crossingAmount;
    }
